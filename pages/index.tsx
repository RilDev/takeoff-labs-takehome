  ...
  return (
    <>
      <div className="flex w-full h-screen bg-white main">
        <div className="flex flex-col flex-shrink-0 items-center px-2 py-6 w-80 border-r chat-list border-gray">
          ...
          <div className="space-y-2 w-full person-list">
            <div className="flex px-2 py-2 w-full h-16 rounded-xl person gray">
              ...
              <div className="flex justify-between items-end ml-4 w-full">
                <div>
                  ...
                  <div className="text-sm tagline text-light-gray">
                    Nice tagline 😊
                  </div>
                </div>
                <div className="text-sm date light-gray">Now</div>
              </div>
            </div>
          </div>
        </div>
